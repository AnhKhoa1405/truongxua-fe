...
class AboutUniversity extends React.Component {
  render() {
    return (
      <div>
        ...
        <div className="theme-layout">
          ...
          <div className="gap no-gap">
            <div className="top-area mate-black low-opacity">
              <div
                className="bg-image"
                style={{ backgroundImage: "url(images/resources/top-bg2.jpg)" }}
              />
                  ...
                  <div className="col-lg-12">
                    <div className="post-subject">
                      ...
                      <ul className="nav nav-tabs post-detail-btn">
                        ...
                        <li className="nav-item">
                          <a className href="#link12" data-toggle="tab">
                            Departments
                          </a>
                        </li>
                        <li className="nav-item">
